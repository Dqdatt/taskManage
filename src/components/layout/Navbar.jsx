...
function Navbar() {
  ...
  return (
    <nav className="h-20 border-b border-white/10 flex items-center justify-between px-8 shrink-0">
      {/* Logo */}
      ...
      <div className="flex relative bg-black/40 rounded-full p-1 border border-white/10 backdrop-blur-md items-center shadow-inner">
        {/* Sliding pill */}
        <div 
